...
// Save this as: app/api/admin/inventory/route.js
...
export async function GET() {
  try {
    ...
    // Get medicines data
    const [medicines] = await connection.execute('SELECT * FROM medicines WHERE is_active = 1');
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        summary: {
          ...
          totalValue: `₹${(totalValue / 100000).toFixed(1)}L` // Convert to L format
        }
      }
    });
