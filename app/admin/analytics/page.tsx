      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Operational insights and performance metrics for your branch</p>
          </div>
        ...
        <Card className="border-pink-100 hover:shadow-lg transition-all duration-300">
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-sm text-gray-600">Today</span>
                <span className="font-semibold text-2xl">₹15,420</span>
              </div>
              <div className="flex justify-between">
          ...
          <CardContent>
            <div className="h-64 bg-gradient-to-br from-pink-50 to-blue-50 rounded-lg flex items-center justify-center">
              <div className="text-center">
                <LineChart className="h-16 w-16 text-pink-300 mx-auto mb-4" />
                <p className="text-gray-500">Patient trend chart will be implemented here</p>
                <p className="text-sm text-gray-400 mt-2">Daily patient registration patterns</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="h-64 bg-gradient-to-br from-green-50 to-purple-50 rounded-lg flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-500">Department performance chart will be implemented here</p>
                <p className="text-sm text-gray-400 mt-2">Patient load by department</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="p-4 bg-green-50 rounded-lg">
                <h4 className="font-semibold text-green-800">Key Achievements</h4>
